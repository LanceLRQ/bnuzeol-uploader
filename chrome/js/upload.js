...
var ifr = document.getElementById("result_frame");
...
submitBtn.addEventListener("click", function () {
    ...
    var options = {
        ...
        success: function (msg) {
            ...
            doc.write("<a href='http://eol.bnuz.edu.cn/meol/"+msg+"'>"+filename+"</a>");
            ifr.focus();
            ifr.contentWindow.document.execCommand('selectAll');
            ifr.contentWindow.document.execCommand('copy', true);
